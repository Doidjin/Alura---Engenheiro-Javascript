                ...
                _createClass(NegociacaoController, [{
                    ...
                    value: function apaga() {
                        ...
                        this._service.apaga().then(function (mensagem) {
                            ...
                            return _this4._mensagem.erro = erro;
                        });
                    }
                }, {
                    key: '_criaNegociacao',
                    value: function _criaNegociacao() {
                        ...
                        return new NegociacaoService(DateHelper.textoParaData(this._inputData.value), parseInt(this._inputQuantidade.value), parseFloat(this._inputValor.value));
                    }
                }, {
